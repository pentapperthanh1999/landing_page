...
<link rel="stylesheet" href="{{asset('frontend/admin/css/morris.css')}}" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="{{asset('frontend/admin/css/monthly.css')}}">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="{{asset('frontend/admin/js/jquery2.0.3.min.js')}}"></script>
<script src="{{asset('frontend/admin/js/raphael-min.js')}}"></script>
<script src="{{asset('frontend/admin/js/morris.js')}}"></script>
</head>